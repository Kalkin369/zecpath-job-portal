...
class CanPostJob(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return SubscriptionService().can_post_job(
            employer
        )
...
class CanUseAI(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        return SubscriptionService().has_ai_access(
            employer
        )
...
class CanUseAnalytics(BasePermission):
    ...
    message = (
        "Upgrade your subscription to access analytics."
    )
