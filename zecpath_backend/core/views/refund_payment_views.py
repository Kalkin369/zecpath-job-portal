...
@extend_schema(
    ...
    responses={
        200: OpenApiResponse(description="Refund initiated successfully."),
        400: OpenApiResponse(description="Invalid payment ID or refund request."),
    ...
    examples=[
        OpenApiExample(
            ...
            value={
                ...
                "data": {"refund_id": "rfnd_QWERTY123456", "status": "pending"},
            },
            response_only=True,
        )
    ],
