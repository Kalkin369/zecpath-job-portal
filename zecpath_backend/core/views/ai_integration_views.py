...
@extend_schema(
    ...
    request=inline_serializer(
        name="GenerateQuestionRequest", fields={"role": serializers.CharField()}
    ),
    responses={
...
@extend_schema(
    ...
    request=inline_serializer(
        name="TextToSpeechRequest", fields={"text": serializers.CharField()}
    ),
    responses={
...
@extend_schema(
    ...
    request=inline_serializer(
        name="SpeechToTextRequest", fields={"audio": serializers.FileField()}
    ),
    responses={
...
@extend_schema(
    ...
    request=inline_serializer(
        name="TriggerCallRequest", fields={"phone": serializers.CharField()}
    ),
    responses={
...
class TriggerCallAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            return handle_exception("TriggerCallAPIView", e, "trigger call failed.")
