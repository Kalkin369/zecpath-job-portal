...
class SubscriptionService:
    ...
    def can_access_candidates(
        ...
        return (
            current_access_count <
            subscription.plan.max_candidate_access
        )
    ...
    def get_subscription_usage(
        ...
        return {
            ...
            "jobs_remaining":
                max(
                    subscription.plan.max_job_posts - jobs_used,
                    0
                ),
    ...
    def get_subscription_access(
        ...
        candidate_access_remaining = max(
            subscription.plan.max_candidate_access - candidate_access_used,
            0
        )
    ...
    def deactivate_all_expired_subscriptions(
        self
    ):
