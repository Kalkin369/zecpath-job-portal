from core.models import AnswerEvaluation, CandidateReport


class CandidateReportService:

    def calculate_ai_score(self, application):
    ...
    def generate_report(
        ...
        ai_score = self.calculate_ai_score(application)
        ...
        if ats_score >= 70:
            ...
            strengths.append("Strong ATS profile")
        ...
        report, created = CandidateReport.objects.update_or_create(
