...
from core.models import (
    AIAnswer, AICall, AIInterviewSession, AIQuestion,
    AnswerEvaluation, Application, ApplicationLog,
    AuditTrail, AvailabilitySlot, BillingHistory, CallLog,
    Candidate, CandidateReport, Employer, ErrorLog,
    InterviewReminder, InterviewSchedule, InterviewState,
    Job, NotificationLog, PaymentTransaction,
    QuestionTemplate, SavedJob, SecurityLog,
    SubscriptionPlan, User, UserSubscription
)
