...
@extend_schema(
    ...
    responses={
        ...
        400: OpenApiResponse(description="Application ID is required."),
        404: OpenApiResponse(description="Application not found."),
        500: OpenApiResponse(description="Failed to generate report."),
    },
)
class GenerateReportAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            serializer = CandidateReportSerializer(report)
            ...
            LoggingService().create_error_log(
                "GenerateReportAPIView", f"Application {application_id} not found"
            )
